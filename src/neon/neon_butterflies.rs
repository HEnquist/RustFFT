...
impl<T: FftNum> NeonF32Butterfly2<T> {
    ...
    pub(crate) unsafe fn perform_parallel_fft_contiguous(
        ...
        let [values_a, values_b] = input.load_interleave2_complex(0);
        ...
        output.store_interleave2_complex(out, 0);
    }
...
impl<T: FftNum> NeonF32Butterfly3<T> {
    ...
    pub(crate) unsafe fn perform_parallel_fft_contiguous(
        ...
        let [value0, value1, value2] = input.load_interleave3_complex(0);
...
//
        ...
        output.store_interleave3_complex(out, 0);
    }
...
impl<T: FftNum> NeonF32Butterfly4<T> {
    ...
    pub(crate) unsafe fn perform_parallel_fft_contiguous(
        ...
        output.store_interleave4_complex(out, 0);
    }
